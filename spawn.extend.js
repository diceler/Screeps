...
Spawn.prototype.bodyTypes = {
  [ROLE.UPGRADER]: rcl => {
    switch (rcl) {
      case 1:
        return this.workerUnitBuild(2, 1, 1);
      case 2:
        return this.workerUnitBuild(2, 4, 2);
      case 3:
        return this.workerUnitBuild(4, 6, 2);
      case 4:
        return this.workerUnitBuild(5, 10, 5);
      default:
        return this.workerUnitBuild(10, 10, 5);
    }
  },
  [ROLE.BUILDER]: rcl => {
    switch (rcl) {
      case 1:
        return this.workerUnitBuild(1, 2, 1);
      case 2:
        return this.workerUnitBuild(2, 4, 2);
      case 3:
        return this.workerUnitBuild(4, 6, 2);
  ...
  [ROLE.HARVESTER]: rcl => {
    switch (rcl) {
      case 1:
      case 2:
        return this.workerUnitBuild(1, 1, 1);
      default:
        return this.workerUnitBuild(5, 1, 5);
    }
  },
  [ROLE.HAULER]: rcl => {
    switch (rcl) {
      case 1:
      case 2:
        return this.workerUnitBuild(0, 4, 2);
      default:
        return this.workerUnitBuild(0, 8, 8);
    }
  },
};

Spawn.prototype.workerUnitBuild = function (workParts, carryParts, moveParts) {
